...
function popupchat(username) {
    ...
    $('#chat-area').append(
        ...
        '</div>' +
        '<div class="msg_footer">' +
        '<textarea autofocus="true" chatusers="' + room + '" onkeypress="send_individual_msg(event,\'' + username + '\',this.getAttribute(\'chatusers\'),value)" placeholder="Send a message..." class="msg_input appChatbox-input" rows="1"></textarea>' +
        '<div class="tool-chat">' +
        '<div class="inputWrapper"><i class="fa fa-camera"></i>' +
        ...
        data.forEach(function (v, index) {
            ...
            if ($('#' + v.receiver).length > 0) {
                ...
                $('#chat-area').append(
                    ...
                    '</div>' +
                    '<div class="msg_footer">' +
                    '<textarea autofocus="true" chatusers="' + v.receiver + '" onkeypress="send_individual_msg(event,\'' + v.sender + '\',this.getAttribute(\'chatusers\'),value)" placeholder="Send a message..." class="msg_input appChatbox-input" rows="1"></textarea>' +
                    '<div class="tool-chat">' +
                    '<div class="inputWrapper"><i class="fa fa-camera"></i>' +
...
function closeChat(room) {
    var r = confirm("Bạn muốn rời khỏi phòng này");
    if(r){
