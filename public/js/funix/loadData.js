...
var Company = {
	init: function(suggestInput){
		suggestInput = suggestInput?suggestInput:'.funix-form-companyIdSuggest';
		$('.funix-form-companyIdSuggest').each(function(){
...
var User = {
		init: function(suggestInput){
			suggestInput = suggestInput?suggestInput:'.funix-form-userIdSuggest';
